...
export function PublicShareDialog({ page, onClose }: PublicShareDialogProps) {
  ...
  const publicUrl = page.publicToken ? `${window.location.origin}/public/${page.publicToken}` : '';
          ...
          {isPublic && publicUrl && (
            <div className="animate-fade-in">
              <label
                ...
                className="text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1.5 block"
              >
                Public Link
              </label>
