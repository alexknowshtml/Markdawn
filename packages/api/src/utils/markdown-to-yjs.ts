...
function createTableRow(node: UnistTableRow, isHeader: boolean, align: (string | null)[]): Y.XmlElement {
...
function createTableCell(node: UnistTableCell, isHeader: boolean, align: string | null): Y.XmlElement {
